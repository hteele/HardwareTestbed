...
HEADER = {
    "name": NAME,
    "description": "Satellites broadcast location on {PREFIX}/satellite/location, and detect and report events on {PREFIX}/satellite/detected and {PREFIX}/satellite/reported. Subscribes to {PREFIX}/fire/location.",
}
